...
def mainlist(item):
    ...
    itemlist = []
    itemlist.append( Item(channel=__channel__, title="[COLOR azure]Ultimi Film Inseriti[/COLOR]", action="peliculas", url="http://cinemastreaming.net/category/streaming/", thumbnail="http://orig03.deviantart.net/6889/f/2014/079/7/b/movies_and_popcorn_folder_icon_by_matheusgrilo-d7ay4tw.png"))
...
def peliculas(item):
    ...
    for scrapedurl,scrapedthumbnail,scrapedtitle in matches:
        ...
        scrapedtitle = scrapertools.decodeHtmlentities(scrapedtitle.replace("_"," "))

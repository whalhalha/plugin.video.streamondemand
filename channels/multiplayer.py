...
def mainlist(item):
    ...
    itemlist = []
    itemlist.append( Item(channel=__channel__, title="[COLOR azure]Recensioni games[/COLOR]", action="peliculas", url="http://multiplayer.it/video/videorecensione/", thumbnail="http://dc584.4shared.com/img/XImgcB94/s7/13feaf0b538/saquinho_de_pipoca_01"))
...
def peliculas(item):
    ...
    # Extrae el paginador
    patronvideos  = '<a href="(.*?)" rel="pagina" class="page_link"><span class="next">&nbsp'

...
# Canal para griffinitastreaming.altervista.org
...
__channel__ = "griffinita"
__category__ = "S"
__type__ = "generic"
__title__ = "GriffinITA Streaming"
__language__ = "IT"

host = "http://griffinitastreaming.altervista.org"
...
def listepisodes(item):
    logger.info("[griffinita.py] episodeslist")
    itemlist = []

...
def channels_list():
    ...
    #itemlist.append( Item( title="[COLOR azure]Saint Seya[/COLOR]"     , channel="saintseya"       , language="IT"    , category="A"        , thumbnail="http://vignette2.wikia.nocookie.net/nonciclopedia/images/1/12/Logo_Cavalieri_dello_Zodiaco.png/revision/latest?cb=20140308215438", type="generic"))

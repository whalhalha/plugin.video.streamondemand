...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]BreakingBadITA Streaming[/COLOR]"      , channel="breakingbadita"           , language="IT"    , category="F,S,A"   , type="generic",thumbnail="http://breakingbaditastreaming.altervista.org/images/logo.png"))
    ...
    itemlist.append( Item( title="[COLOR azure]FuturamaITA Streaming[/COLOR]"      , channel="futuramaita"           , language="IT"    , category="F,S,A"   , type="generic",thumbnail="http://imageshack.com/a/img907/7526/TFc1Wg.jpg"))
    ...
    itemlist.append( Item( title="[COLOR azure]GriffinITA Streaming[/COLOR]"      , channel="griffinita"           , language="IT"    , category="F,S,A"   , type="generic",thumbnail="http://griffinitastreaming.altervista.org/images/logo.png"))
    ...
    itemlist.append( Item( title="[COLOR azure]SimpsonITA Streaming[/COLOR]"      , channel="simpsonita"           , language="IT"    , category="F,S,A"   , type="generic",thumbnail="http://i.imgur.com/o8JAj9j.jpg"))

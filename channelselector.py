...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]SimpsonITA Streaming[/COLOR]"      , channel="simpsonita"           , language="IT"    , category="F,S,A"   , type="generic",thumbnail="http://thesimpsonstreaming.altervista.org/wp-content/uploads/2013/04/Senzatitolo-11.png"))

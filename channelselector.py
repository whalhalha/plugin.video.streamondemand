...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]SimpsonITA Streaming[/COLOR]"      , channel="simpsonita"           , language="IT"    , category="F,S,A"   , type="generic",thumbnail="https://imageshack.com/i/p7b0Y5fqj"))
